...
- `game/` – elva spelbara prototyper (HANGRY, Dörrvakten, Sushi-kast, Jenga-huset, Tunnelbanan, Sysslor, Pannkakstornet, Fikapausen, Matkriget, Kebabspettet, Nummerlappen). Öppna `game/index.html`. Se `game/README.md` för länkar att spela på mobilen.
