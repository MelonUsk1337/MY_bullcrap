...
- `game/` – tolv spelbara prototyper: Food Wars (samlingen med nio mikrospel), HANGRY, Dörrvakten, Sushi-kast, Jenga-huset, Tunnelbanan, Sysslor, Pannkakstornet, Fikapausen, Matkriget, Kebabspettet, Nummerlappen. Öppna `game/index.html`. Se `game/README.md` för länkar att spela på mobilen.
...
- `docs/IDEAS-FOOD.md` – 20 spelidéer på mat-temat, fyra av dem byggda.
